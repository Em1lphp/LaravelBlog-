...
<header class="edica-header">
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="{{route('main.index')}}"><img class="w-50"
                                                                        src="{{asset('assets/images/Logo blog.jpg')}}"
                                                                        alt="Edica"></a>
            ...
            <div class="collapse navbar-collapse" id="edicaMainNav">
                ...
                <ul class="navbar-nav mt-2 mt-lg-0">
                    ...
                    <li class="nav-item">
                        @auth()
                            <a class="nav-link" href="{{route('personal')}}">Personal Account</a>
                        @endauth
                        @guest()
    ...
    <div class="container">
        <div class="row footer-widget-area">
            <div class="col-md-3">
                ...
                <p class="contact-details">work.emil01@gmail.com</p>
                <p class="contact-details">@dadalso</p>
